...
export default function FloatingChatbot() {
  ...
  return (
    <Card className="fixed bottom-5 right-5 w-80 sm:w-96 shadow-xl z-50">
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          <CardTitle className="text-sm">SafeGuard Assistant</CardTitle>
      ...
      <CardFooter className="flex gap-2 pt-0 px-3 pb-3">
        <Textarea
          ...
          className="flex-1 resize-none text-sm min-h-9 py-2"
          onKeyDown={(e) => {
