...
export class FirebaseStorage implements IStorage {
  ...
  async createUser(user: InsertUser): Promise<User> {
    ...
    return { ...user, id: userDocRef.id }; // Return the created user with id
  }
  ...
  async createChild(child: InsertChild): Promise<Child> {
    ...
    return { ...child, id: childDocRef.id }; // Return the created child with id
  }
  ...
  async createActivity(activity: InsertActivity): Promise<Activity> {
    ...
    return { ...activity, id: activityDocRef.id }; // Return the created activity with id
  }
  ...
  async createBlockedSite(site: InsertBlockedSite): Promise<BlockedSite> {
    ...
    return { ...site, id: siteDocRef.id }; // Return the created site with id
  }
  ...
  async createDeviceSettings(
    ...
    return { ...settings, id: settingsDocRef.id }; // Return the created settings with id
  }
